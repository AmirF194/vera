...
| `sqlitedb.vera` | `vera run examples/sqlitedb.vera` | <DB> effect reading a committed on-disk SQLite file (`VERA_DB_URL=sqlite:///examples/sqlitedb.sqlite`); Option<String> cells, graceful Err by default |
