...
| v0.1.5 | 17 Jul | **The third burndown and the first PyPI release** — 27 checker, codegen, and diagnostics bug fixes, published to PyPI as `veralang` ([#737](https://github.com/aallan/vera/issues/737)). |
...
| Tests | ~50 | ~300 | ~1,400 | 3,095 | 4,342 | 5,559 | 5,615 | 5,808 | 6,779 | 7,945 |
| Examples | 13 | 15 | 18 | 30 | 35 | 35 | 36 | 36 | 37 | 38 |
| Built-in functions | 0 | 0 | ~30 | 122 | 164 | 164 | 164 | 164 | 164 | 164 |
| Conformance programs | 0 | 0 | 0 | 64 | 89 | 103 | 104 | 104 | 143 | 161 |
