...
| `  registration.py` | 528 | | Pass 1 forward declarations, ability registration | |
...
| `  contracts.py` | 1,258 | | Runtime pre/postconditions, old state snapshots, decreases termination guard (entry check-and-set, per-function chain state, ADT rank helpers, self-tail site checks) | |
