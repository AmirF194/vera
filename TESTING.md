...
| Metric | Value |
|--------|-------|
| **Tests** | 7,996 across 127 files (~106,000 lines of test code; 7,891 passed + 26 stress, 79 skipped) |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (163 programs, see manifest.json)
...
| `test_codegen_collections.py` | 69 | 1,132 | Map + Set collections (#62), wrapper-handle bit-31 tagging (#578) (#419 split) |
...
| `test_conformance.py` | 815 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 163 programs |
...
| `run` | Compiles to WASM and executes correctly | 131 |
...
├── ...                        # 163 programs total, organized by spec chapter
