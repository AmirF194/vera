...
| Metric | Value |
|--------|-------|
| **Tests** | 7,400 across 120 files (~104,000 lines of test code; 7,304 passed + 26 stress, 70 skipped) |
...
| `test_codegen_host_effects.py` | 58 | 961 | Html/Http/Inference host effects, provider dispatch, postcondition host-import propagation (#823) (#419 split) |
