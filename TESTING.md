...
| Metric | Value |
|--------|-------|
| **Tests** | 6,721 across 104 files (~79,000 lines of test code; 6,633 passed + 26 stress, 62 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 141 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (141 programs, see manifest.json)
...
| `test_conformance.py` | 705 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 141 programs |
...
├── ...                        # 141 programs total, organized by spec chapter
