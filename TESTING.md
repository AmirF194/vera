...
| Metric | Value |
|--------|-------|
| **Tests** | 8,020 across 127 files (~106,000 lines of test code; 7,915 passed + 26 stress, 79 skipped) |
...
| `test_formatter.py` | 135 | 1,138 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
