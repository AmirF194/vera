...
| Metric | Value |
|--------|-------|
| **Tests** | 6,671 across 102 files (~79,000 lines of test code; 6,586 passed + 26 stress, 59 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 139 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (139 programs, see manifest.json)
...
| `test_conformance.py` | 695 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 139 programs |
...
| `run` | Compiles to WASM and executes correctly | 115 |
...
├── ...                        # 139 programs total, organized by spec chapter
