...
| Metric | Value |
|--------|-------|
| **Tests** | 8,601 across 131 files (~106,000 lines of test code; 8,485 passed + 26 stress, 90 skipped) |
...
| `test_conformance.py` | 845 | 125 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 169 programs |
...
| `check_corpus_canonical.py` | All 217 corpus programs (recursive over `examples/` + `tests/conformance/`) are in canonical form under `vera fmt` |
