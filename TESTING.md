...
| Metric | Value |
|--------|-------|
| **Tests** | 8,444 across 130 files (~106,000 lines of test code; 8,339 passed + 26 stress, 79 skipped) |
...
| `check_corpus_canonical.py` | All 212 corpus programs (recursive over `examples/` + `tests/conformance/`) are in canonical form under `vera fmt` |
...
| `check_corpus_canonical.py` | All 212 `examples/` + `tests/conformance/` programs (recursive) are in canonical form (`vera fmt`) |
