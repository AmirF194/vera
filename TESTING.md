...
| Metric | Value |
|--------|-------|
| **Tests** | 8,247 across 127 files (~106,000 lines of test code; 8,142 passed + 26 stress, 79 skipped) |
...
| `test_formatter.py` | 362 | 1,616 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
