...
| Metric | Value |
|--------|-------|
| **Tests** | 7,405 across 120 files (~104,000 lines of test code; 7,309 passed + 26 stress, 70 skipped) |
...
| `test_codegen_contracts.py` | 33 | 595 | Runtime pre/postconditions, contract fail messages, old/new state postconditions, the #958 tier-agnostic always-emit pin |
