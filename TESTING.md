...
| Metric | Value |
|--------|-------|
| **Tests** | 6,599 across 101 files (~79,000 lines of test code; 6,519 passed + 26 stress, 54 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 136 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (136 programs, see manifest.json)
...
| `test_browser.py` | 132 | 2,892 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
| `test_conformance.py` | 680 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 136 programs |
...
| `run` | Compiles to WASM and executes correctly | 113 |
...
├── ...                        # 136 programs total, organized by spec chapter
