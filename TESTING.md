...
| Metric | Value |
|--------|-------|
| **Tests** | 8,288 across 127 files (~106,000 lines of test code; 8,176 passed + 26 stress, 79 skipped) |
...
| `test_formatter.py` | 397 | 1,999 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
