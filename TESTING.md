...
| Metric | Value |
|--------|-------|
| **Tests** | 6,460 across 99 files (~79,000 lines of test code; 6,382 passed + 26 stress, 52 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 130 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (130 programs, see manifest.json)
...
| `test_conformance.py` | 650 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 130 programs |
...
| `run` | Compiles to WASM and executes correctly | 107 |
...
├── ...                        # 130 programs total, organized by spec chapter
