...
| Metric | Value |
|--------|-------|
| **Tests** | 6,046 across 96 files (~79,000 lines of test code; 5,955 passed + 26 stress, 43 skipped) |
...
| `test_verifier_calls_modules.py` | 52 | 1205 | Call-site preconditions (incl. branch-aware and ADT-typed args, #882), pipe-operator verification, cross-module contracts (#839 split) |
