...
| Metric | Value |
|--------|-------|
| **Tests** | 7,475 across 121 files (~104,000 lines of test code; 7,379 passed + 26 stress, 70 skipped) |
...
| `test_verifier_calls_modules.py` | 56 | 1,364 | Call-site preconditions (incl. branch-aware), pipe-operator verification, cross-module contracts (#839 split) |
