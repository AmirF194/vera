...
| Metric | Value |
|--------|-------|
| **Tests** | 8,272 across 127 files (~106,000 lines of test code; 8,167 passed + 26 stress, 79 skipped) |
...
|------|------:|------:|----------------|
| `test_parser.py` | 145 | 1177 | Grammar rules, operator precedence, parse errors |
...
| `test_formatter.py` | 387 | 1,758 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
