...
| Metric | Value |
|--------|-------|
| **Tests** | 8,723 across 133 files (~106,000 lines of test code; 8,599 passed + 26 stress, 98 skipped) |
...
| `test_checker_modules.py` | 57 | 1270 | Module-call diagnostics, cross-module typing, visibility enforcement, builtin redefinition (function E151 and effect E152 surfaced from a module into its importer), reserved function names (`old` / `new`, E153 — top-level, `where`-helper, and module-surfaced, with the probe record for why the reserved set is exactly those two), parsed module calls (#420 split) |
