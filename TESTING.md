...
| Metric | Value |
|--------|-------|
| **Tests** | 6,684 across 102 files (~79,000 lines of test code; 6,599 passed + 26 stress, 59 skipped) |
...
| `run` | Compiles to WASM and executes correctly | 116 |
