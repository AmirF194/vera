...
| Metric | Value |
|--------|-------|
| **Tests** | 8,031 across 127 files (~106,000 lines of test code; 7,926 passed + 26 stress, 79 skipped) |
...
|------|------:|------:|----------------|
| `test_parser.py` | 145 | 1176 | Grammar rules, operator precedence, parse errors |
...
| `test_formatter.py` | 146 | 1,385 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
