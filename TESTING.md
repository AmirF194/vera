...
| Metric | Value |
|--------|-------|
| **Tests** | 7,485 across 121 files (~104,000 lines of test code; 7,389 passed + 26 stress, 70 skipped) |
...
| `test_verifier_calls_modules.py` | 59 | 1,486 | Call-site preconditions (incl. branch-aware), pipe-operator verification, cross-module contracts (#839 split) |
