...
| Metric | Value |
|--------|-------|
| **Tests** | 6,041 across 96 files (~79,000 lines of test code; 5,972 passed + 26 stress, 43 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 109 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (109 programs, see manifest.json)
...
| `test_checker_types.py` | 123 | 1541 | Primitive types, literals, binary/unary ops, generics, constructors, refinement types, arrays, tuples, return/match-arm types, byte-arithmetic + integer-literal-range rejection (#420 split) |
...
| `test_browser.py` | 111 | 2,360 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
| `test_conformance.py` | 545 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 109 programs |
...
├── ...                        # 109 programs total, organized by spec chapter
