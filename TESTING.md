...
| Metric | Value |
|--------|-------|
| **Tests** | 7,639 across 122 files (~104,000 lines of test code; 7,538 passed + 26 stress, 75 skipped) |
...
| `test_codegen_arrays.py` | 129 | 2,428 | Byte type, array literals / bounds checking / length / range / concat, direct indexing of builtin call results (#1048), construction builtins (#209), compound element types (#132), `Future<alias>` element sizing (#1074), array utilities (#419 split) |
