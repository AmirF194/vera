...
| Metric | Value |
|--------|-------|
| **Tests** | 7,973 across 127 files (~106,000 lines of test code; 7,869 passed + 26 stress, 78 skipped) |
...
```bash
# Via pytest (parametrized — 810 tests)
