...
| Metric | Value |
|--------|-------|
| **Tests** | 8,566 across 131 files (~106,000 lines of test code; 8,450 passed + 26 stress, 90 skipped) |
...
| `test_browser.py` | 138 | 3,100 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
