...
| Metric | Value |
|--------|-------|
| **Tests** | 6,617 across 101 files (~79,000 lines of test code; 6,535 passed + 26 stress, 56 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 137 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (137 programs, see manifest.json)
...
| `test_conformance.py` | 685 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 137 programs |
...
├── ...                        # 137 programs total, organized by spec chapter
