...
| Metric | Value |
|--------|-------|
| **Tests** | 8,034 across 127 files (~106,000 lines of test code; 7,929 passed + 26 stress, 79 skipped) |
...
| `test_formatter.py` | 149 | 1,462 | Comment extraction, interior comment positioning, expression/declaration formatting, match arm block bodies, idempotency, parenthesization, spec rules, ability declarations |
