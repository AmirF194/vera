...
| Metric | Value |
|--------|-------|
| **Tests** | 6,650 across 102 files (~79,000 lines of test code; 6,510 passed + 26 stress, 54 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 138 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (138 programs, see manifest.json)
...
| `test_conformance.py` | 690 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 138 programs |
...
| `check` | Parses and type-checks cleanly | 12 |
| `verify` | Type-checks and all contracts verified by Z3 | 12 |
| `run` | Compiles to WASM and executes correctly | 114 |
...
├── ...                        # 138 programs total, organized by spec chapter
