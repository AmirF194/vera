...
| Metric | Value |
|--------|-------|
| **Tests** | 8,401 across 130 files (~106,000 lines of test code; 8,296 passed + 26 stress, 79 skipped) |
...
| `test_browser.py` | 138 | 3,095 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
