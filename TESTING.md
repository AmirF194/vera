...
| Metric | Value |
|--------|-------|
| **Tests** | 6,404 across 99 files (~79,000 lines of test code; 6,290 passed + 26 stress, 50 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 128 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (128 programs, see manifest.json)
...
| `test_conformance.py` | 640 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 128 programs |
...
| `run` | Compiles to WASM and executes correctly | 105 |
...
├── ...                        # 128 programs total, organized by spec chapter
