...
| Metric | Value |
|--------|-------|
| **Tests** | 8,856 across 136 files (~106,000 lines of test code; 8,728 passed + 26 stress, 102 skipped) |
...
| `test_verifier_adt_decreases.py` | 22 | 781 | Match/ADT verification, decreases measures (incl. ADT decreases), mutual recursion (#839 split) |
