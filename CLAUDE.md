...
python scripts/check_conformance.py    # Verify all 141 conformance programs (positives pass their level; negatives fail with their expected_error E-code)
...
- `tests/conformance/` — 141 conformance programs validating every language feature against the spec
