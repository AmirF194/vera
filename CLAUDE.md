...
python scripts/check_conformance.py    # Verify all 243 conformance programs (positives pass their level; negatives fail with their expected_error E-code)
...
python scripts/check_corpus_canonical.py # Verify all 292 corpus programs are in canonical form (vera fmt)
...
- `tests/conformance/` — 243 conformance programs validating every language feature against the spec
