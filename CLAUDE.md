...
python scripts/check_corpus_canonical.py # Verify all 287 corpus programs are in canonical form (vera fmt)
...
- `tests/conformance/` — 238 conformance programs validating every language feature against the spec
