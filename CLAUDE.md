...
python scripts/check_conformance.py    # Verify all 241 conformance programs (positives pass their level; negatives fail with their expected_error E-code)
...
python scripts/check_corpus_canonical.py # Verify all 290 corpus programs are in canonical form (vera fmt)
...
- `tests/conformance/` — 241 conformance programs validating every language feature against the spec
