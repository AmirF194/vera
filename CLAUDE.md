...
python scripts/check_conformance.py    # Verify all 242 conformance programs (positives pass their level; negatives fail with their expected_error E-code)
...
python scripts/check_corpus_canonical.py # Verify all 291 corpus programs are in canonical form (vera fmt)
...
- `tests/conformance/` — 242 conformance programs validating every language feature against the spec
